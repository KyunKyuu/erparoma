<!-- Modal -->
<div class="modal fade" id="updateEmployee" data-backdrop="static" data-keyboard="false" tabindex="-1"
    aria-labelledby="updateEmployeeLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-md-12">
                    <form class="updateForm" data-url="/api/v1/employee/update" data-method="post">
                        ...
                        <div class="text-center" id="tampil-data-update">
                            <a href="#" id="personal-klik-update">Tampilkan data pribadi</a>
                        </div>


                        {{-- Data Pribadi --}}
                        <div id="personal-data-update" style="display: none">
                            <div class="form-group row">
                                <div class="col">

<!-- Modal -->
<div class="modal fade" id="updateCompanyProfile" data-backdrop="static" data-keyboard="false" tabindex="-1"
    aria-labelledby="updateCompanyProfileLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateCompanyProfileLabel">Tambah Company Profile</h5>
            ...
            <div class="modal-body">
                <div class="col-md-12">
                <form class="updateForm" data-url="/api/v1/company_profiles/update" data-method="post" enctype="multipart/form-data">

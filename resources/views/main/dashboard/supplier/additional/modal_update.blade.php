<!-- Modal -->
<div class="modal fade" id="updateSupplier" data-backdrop="static" data-keyboard="false" tabindex="-1"
    aria-labelledby="updateSupplierLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateSupplierLabel">Edit Supplier</h5>
            ...
            <div class="modal-body">
                <div class="col-md-12">
                    <form class="updateForm" data-url="/api/v1/suppliers/update" data-method="post">

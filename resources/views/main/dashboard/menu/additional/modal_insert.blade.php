...
<!-- Modal -->
<div class="modal fade" id="insertMenu" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="insertMenuLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="insertMenuLabel">Tambah Menu</h5>
        ...
        <div class="modal-body">
            <div class="col-md-12">
                  <form class="insertForm" data-url="/api/v1/menu/insert" data-method="post">
